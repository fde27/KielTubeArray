#ifndef __SPARKFUN_LPS28DFW_W2_H__
#define __SPARKFUN_LPS28DFW_W2_H__
...
struct LPS28DFW_W2_InterfaceData
{
    // I2C settings
    uint8_t i2cAddress;
    TwoWire* i2cPort;
...
class LPS28DFW_W2
{
    public:
        ...
        int32_t begin(uint8_t address = LPS28DFW_I2C_ADDRESS_DEFAULT, TwoWire& wirePort = Wire2);
    ...
    private:
        ...
        LPS28DFW_W2_InterfaceData interfaceData;
