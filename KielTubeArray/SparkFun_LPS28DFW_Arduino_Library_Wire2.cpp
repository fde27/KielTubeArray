...
int32_t LPS28DFW_W2::begin(uint8_t address, TwoWire& wirePort)
{
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::setModeConfig(lps28dfw_md_t* config)
{
    // Variable to track errors returned by API calls
    int32_t err = LPS28DFW_OK;
...
/// @param config Struct of configuration parameters, see lps28dfw_md_t
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::getModeConfig(lps28dfw_md_t* config)
{
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::getStatus(lps28dfw_stat_t* status)
{
...
/// the data struct
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::getSensorData()
{
    // Variable to track errors returned by API calls
    int32_t err = LPS28DFW_OK;
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::setInterruptMode(lps28dfw_int_mode_t* intMode)
{
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::enableInterrupts(lps28dfw_pin_int_route_t* intRoute)
{
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::getInterruptStatus(lps28dfw_all_sources_t* status)
{
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::setFIFOConfig(lps28dfw_fifo_md_t* fifoConfig)
{
...
/// @param fifoConfig FIFO config, see lps28dfw_fifo_md_t
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::getFIFOConfig(lps28dfw_fifo_md_t* fifoConfig)
{
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::getFIFOLength(uint8_t* numData)
{
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::getFIFOData(lps28dfw_fifo_data_t* data, uint8_t numData)
{
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::setReferenceMode(lps28dfw_ref_md_t* mode)
{
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::setThresholdMode(lps28dfw_int_th_md_t* mode)
{
    // Variable to track errors returned by API calls
    int32_t err = LPS28DFW_OK;
...
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::getReferencePressure(int16_t* pressRaw)
{
    return lps28dfw_refp_get(&sensor, pressRaw);
}

/// @brief Helper function to read sensor registers over I2C
/// @param interfacePtr Pointer to interface data, see LPS28DFW_W2_InterfaceData
/// @param regAddress Start address to read
/// @param dataBuffer Buffer to store register values
/// @param numBytes Number of bytes to read
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::readRegisters(void* interfacePtr, uint8_t regAddress, uint8_t* dataBuffer, uint16_t numBytes)
{
    ...
    // Get interface data
    LPS28DFW_W2_InterfaceData* interfaceData = (LPS28DFW_W2_InterfaceData*) interfacePtr;
...
/// @param numBytes Number of bytes to read
/// @return Error code. 0 means success, negative means failure
int32_t LPS28DFW_W2::writeRegisters(void* interfacePtr, uint8_t regAddress, const uint8_t* dataBuffer, uint16_t numBytes)
{
    // Make sure the number of bytes is valid
    if(numBytes == 0)
    {
...
void LPS28DFW_W2::msDelay(uint32_t period)
{
    delay(period);
}